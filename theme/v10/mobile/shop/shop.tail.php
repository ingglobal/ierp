...
<div id="ft">
    ...
    <div id="ft_logo"><a href="<?php echo G5_URL; ?>/"><img src="<?php echo G5_DATA_URL; ?>/common/mobile_logo_img2" alt="<?php echo $config['cf_title']; ?> 메인"></a></div>
    <p>
    ...
    <?php
    if(G5_DEVICE_BUTTON_DISPLAY && G5_IS_MOBILE && defined('_INDEX_') && $is_admin=='super') { ?>
