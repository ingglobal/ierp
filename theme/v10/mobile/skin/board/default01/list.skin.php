...
#bo_btn_top .allchk_box{position:absolute;bottom:0;right:10px;}
</style>
...
<?php if ($rss_href || $write_href) { //상단탑 버튼 ?>
<div class="btn_fixed_top">
    <ul class="<?php echo isset($view) ? 'view_is_list btn_top' : 'btn_top top btn_bo_user';?>">
        <?php if (false){ //($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="btn_admin btn" title="관리자"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">관리자</span></a></li><?php } ?>
        ...
        <?php } ?>
        <?php if ($write_href && $member['mb_6'] <= 2) { ?><li><a href="<?php echo $write_href ?>" class="fix_btn write_btn" title="글쓰기"><i class="fa fa-plus" aria-hidden="true"></i><span class="sound_only">글쓰기</span></a></li><?php } ?>
    </ul>
</div>
<?php } ?>
<!-- 게시판 목록 시작 -->
<div id="bo_list">
    ...
    <div class="list_01">
        <ul>
            ...
            ?>
            <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?><?=$bg?>">
                <?php if ($is_checkbox) { ?>
