    ...
    <ul class="btn_top top btn_bo_user"> 
        ...
        <li>
            ...
            <ul class="more_opt is_view_btn">
                <?php if ($reply_href && $member['mb_6'] <= 2) { ?><li><a href="<?php echo $reply_href ?>"><i class="fa fa-reply" aria-hidden="true"></i> 답변</a></li><?php } ?>
        ...
        <?php if ($write_href && $member['mb_6'] <= 2) { ?><li><a href="<?php echo $write_href ?>" class="btn_b03 btn bt_write" title="글쓰기" style="color:#fff !important;"><i class="fa fa-plus" aria-hidden="true"></i><span class="sound_only">글쓰기</a></li><?php } ?>
    </ul>
</div>
<script>
jQuery(function($){
