...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_control">
        <table>
            <tbody><tr>
                ...
                <tr>
                    <th>접수번호</th>
                    <td><?=$view['wr_twitter_user']?></td>
                </tr>
                <tr>
                    <th>방문예정일</th>
                    <td><?=$view['wr_facebook_user']?></td>
                </tr>
                <tr>
                    <th>AS담당자</th>
                    <td><?=$view['wr_5']?></td>
                ...
                <tr>
                    <th>비용</th>
                    <td><?=number_format($view['wr_7'])?>원</td>
                </tr>
                <tr>
                    <th>접수경로</th>
                    <td><?=$g5['set_as_receiptpath_value'][$view['wr_9']]?></td>
                </tr>
                <tr>
                    <th>처리상태</th>
                    <td><?=$g5['set_as_status_value'][$view['wr_10']]?></td>
                </tr>
            </tbody>
        </table>
    </section>
    ...
    <section id="bo_v_atc">
        <h2 id="bo_v_atc_title1">접수내용</h2>
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con"><?php echo get_view_thumbnail($view['content']); ?></div>
        <h2 id="bo_v_atc_title1">조치내용</h2>
        <div id="bo_v_con2"><?php echo get_view_thumbnail($view['wr_link1']); ?></div>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_left">
            <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_b01 btn"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></li><?php } ?>
            <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn_b01 btn" onclick="del(this.href); return false;"><i class="fa fa-trash-o" aria-hidden="true"></i></a></li><?php } ?>
            <?php if ($copy_href) { ?><li><a href="<?php echo $copy_href ?>" class="btn_admin btn" onclick="board_move('<?php echo $board_skin_url;;?>/move.php?sw=copy&bo_table=<?php echo $bo_table;?>&wr_id=<?php echo $wr_id;?>'); return false;"><i class="fa fa-files-o" aria-hidden="true"></i></a></li><?php } ?>
            <?php if ($move_href) { ?><li><a href="<?php echo $move_href ?>" class="btn_admin btn" onclick="board_move('<?php echo $board_skin_url;?>/move.php?sw=move&bo_table=<?php echo $bo_table;?>&wr_id=<?php echo $wr_id;?>'); return false;"><i class="fa fa-arrows" aria-hidden="true"></i></a></li><?php } ?>
            <?php if ($search_href) { ?><li><a href="<?php echo $search_href ?>" class="btn_b01 btn"><i class="fa fa-search" aria-hidden="true"></i> 검색</a></li><?php } ?>
        </ul>

        <ul class="bo_v_com">
           <li><a href="<?php echo $list_href ?>" class="btn_b01 btn"><i class="fa fa-list" aria-hidden="true"></i></a></li>
            <?php if ($reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="btn_b01 btn"><i class="fa fa-reply" aria-hidden="true"></i></a></li><?php } ?>
