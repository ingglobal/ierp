...
<ul class="btn_top top btn_bo_user">
    ...
    <?php } ?>
    <?php if($member['mb_6'] == 1 || $member['mb_level'] >= 8) { ?><li><a href="<?php echo $write_href ?>" class="btn_b03 btn" title="글쓰기"><i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only">글쓰기</a></li><?php } ?>
	...
	<li>
	    ...
	    <ul class="more_opt is_view_btn">
	    	<?php if($member['mb_6'] == 1 || $member['mb_level'] >= 8) { ?><li><a href="<?php echo $reply_href ?>"><i class="fa fa-reply" aria-hidden="true"></i> 답변</a></li><?php } ?>
