...
?>
<style>
.container_wr{position:relative;min-height:510px;}    
</style>
<section id="bo_w">
    ...
    <div class="btn_fixed_top">
        <?php if($calendar){ ?>
            <a href="<?=G5_USER_ADMIN_URL?>/bbs_board.php?bo_table=<?=$bo_table?>&calendar=<?=$calendar?>" cal="" class="btn_cancel btn" style="background-color:#888 !important;color:#fff !important;">취소</a>
        <?php } else { ?>
            <a href="<?=G5_USER_ADMIN_URL?>/bbs_board.php?bo_table=<?=$bo_table?>&amp;<?=$qstr?>" cla="" class="btn_cancel btn" style="background-color:#888 !important;color:#fff !important;">취소</a>
        <?php } ?>
        <?php if ($w == 'u' && $delete_href) { ?><a href="<?php echo $delete_href ?>" class="btn_02 btn btn_del">삭제</a><?php } ?>
