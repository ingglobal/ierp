    ...
    <div class="list_01">
        ...
        <ul>
            ...
            <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                ...
                <?php if($list[$i]['wr_5']){ ?>
                    <div class="bo_cnt2">
                        <a href="<?php echo $list[$i]['href'] ?>"><?php echo cut_str($list[$i]['wr_5'],40,'...') ?></a>
                    </div>
                <?php } ?>
				<div class="bo_info">
                    <strong class="sound_only_">부서: </strong><span><?php echo $g5['set_department_name_value'][$list[$i]['wr_1']]; ?></span><!--관련부서-->
                    <strong class="bo_date">등록일: </strong><span></span><?php echo $list[$i]['datetime2'] ?></span>
                	<strong class="bo_view">책임자: </strong><span><?php echo $list[$i]['wr_3']; ?></span>
                    <?php
                    $status_class = '';
                    if($list[$i]['wr_4'] == 'pending') $status_class = ' txt_redblink';
                    else if($list[$i]['wr_4'] == 'check') $status_class = ' txt_blueblink';
                    ?>
                    <strong class="bo_stat">상태: </strong><span class="<?=$status_class?>"><?php echo $g5['set_agenda_status_value'][$list[$i]['wr_4']]; ?></span>
                </div>        
            </li>
            <?php } ?>
