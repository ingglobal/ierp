...
<div class="btn_fixed_top">
    <ul class="btn_top_v top btn_bo_user"> 
        <li>
            ...
            <ul class="more_opt is_view_btn">
                <?php if ($member['mb_6'] <= 2) { ?><li><a href="<?php echo $reply_href ?>"><i class="fa fa-reply" aria-hidden="true"></i> 답변</a></li><?php } ?>
                <?php if ($member['mb_6'] <= 2) { ?><li><a href="<?php echo $update_href ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 수정</a></li><?php } ?>
                <?php if ($member['mb_6'] <= 2) { ?><li><a href="<?php echo $delete_href ?>" onclick="del(this.href); return false;"><i class="fa fa-trash-o" aria-hidden="true"></i> 삭제</a></li><?php } ?>
                <?php if ($member['mb_6'] <= 2) { ?><li><a href="<?php echo $copy_href ?>" onclick="board_move(this.href); return false;"><i class="fa fa-files-o" aria-hidden="true"></i> 복사</a></li><?php } ?>
                <?php if ($member['mb_6'] <= 2) { ?><li><a href="<?php echo $move_href ?>" onclick="board_move(this.href); return false;"><i class="fa fa-arrows" aria-hidden="true"></i> 이동</a></li><?php } ?>
                <?php if ($search_href) { ?><li><a href="<?php echo $search_href ?>">검색</a></li><?php } ?>
                <li><a href="<?php echo $board_skin_url?>/list.calendar.php?bo_table=<?php echo $bo_table?>" class="btn_list"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
            </ul>
        ...
        <?php } ?>
        <?php if (false){ //($board['bo_use_sns'] || $scrap_href){ ?>
        <li class="bo_share">
        ...
        <?php } ?>
        <?php if ($member['mb_6'] <= 2) { ?><li><a href="<?php echo $write_href ?>" class="btn_01 btn" title="글쓰기"><i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only">글쓰기</a></li><?php } ?>
