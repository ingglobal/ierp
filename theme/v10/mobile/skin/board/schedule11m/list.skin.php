...
.btns_top_box .local_ov{position:relative;}
.btns_top_box .local_ov .all_chk{position:absolute;bottom:0;right:10px;}
</style>
    ...
    <div class="list_01">
        <div class="btns_top_box">
            <div class="local_ov01 local_ov">
                ...
                <?php if ($is_checkbox) { ?>
                <div class="all_chk chk_box" style="display:inline-block;">
            ...
            ?>
            <div class="btn_left">
                <a href="<?php echo $calendar_url?>" class="btn_mode btn_calendar"><i class="fa fa-calendar"></i></a>
                <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=<?php echo $bo_table?>" class="btn_mode btn_list"><i class="fa fa-list-alt"></i></a>
            </div>
            ...
            <div class="btn_fixed_top">
                <ul class="<?php echo isset($view) ? 'view_is_list btn_top' : 'btn_top top btn_bo_user';?>">
                    ...
                    <?php } ?>
                    <?php if ($member['mb_6'] <= 2) { ?><li><a href="<?php echo $write_href ?>" class="btn_01 btn" title="글쓰기"><i class="fa fa-plus" aria-hidden="true"></i><span class="sound_only">글쓰기</span></a></li><?php } ?>
                </ul>
            </div>
            <?php } ?>
        </div>
        ...
        <ul>
            ...
            <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                ...
                <div class="bo_cnt">
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>" class="bo_subject" style="color:#333;">
