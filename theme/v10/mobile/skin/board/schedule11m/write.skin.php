...
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/style3.css">', 0);
?>
...
#bo_w .bo_v_option{position:relative;height:25px;}
#bo_w .bo_v_option:after{display:block;visibility:hidden;clear:both;content:'';}
#bo_w .bo_v_option .chk_box{top:0;}
</style>
...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="write_div" style="margin-top:10px;">
            ...
            <select name="wr_1" id="wr_1" class="frm_input" style="width:100%;">
        ...
        <div class="write_div" style="margin-top:10px;">
            ...
            <input type="text" name="wr_5" value="<?php echo $write['wr_5'] ?>" id="wr_5" class="frm_input full_input" placeholder="장소">
        </div>
        <div class="write_div" style="margin-top:10px;">
            <label for="wr_2" class="sound_only">날짜</label>
            <input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2" class="frm_input full_input" placeholder="날짜">
        </div>
        <div class="write_div" style="margin-top:10px;padding-bottom:10px;">
            <label for="wr_3" class="sound_only">시작시간</label>
            <select class="from_time" name="wr_3" id="wr_3"></select>
            ~
            <label for="wr_4" class="sound_only">종료시간</label>
            <select class="to_time" name="wr_4" id="wr_4"></select>
        </div>
        ...
        <div class="bo_w_link write_div" style="margin-top:10px;position:relative;">
        ...
        <div class="bo_w_flie write_div" style="margin-top:10px;">
    ...
    <div class="btn_fixed_top">
        <a href="<?php echo get_pretty_url($bo_table); ?>" class="btn_02 btn"><i class="fa fa-times" aria-hidden="true"></i></a>
        <?php if($member['mb_6'] <= 2){ ?>
        <button type="submit" id="btn_submit" class="btn_01 btn" accesskey="s"><i class="fa fa-check" aria-hidden="true"></i></button>
        <?php } ?>
    </div>
    </form>
</section>
...
<script>
$('select[name="wr_3"]').val("<?=$write['wr_3']?>");
$('select[name="wr_4"]').val("<?=$write['wr_4']?>");
