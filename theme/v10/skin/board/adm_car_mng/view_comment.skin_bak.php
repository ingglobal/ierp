...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <div id="inf">
        ...
        <div class="inf_in inf_right">
            ...
            <textarea id="wr_content" name="wr_content" maxlength="10000" required class="required" title="관리내용" placeholder="관리내용을 입력해주세요" 
            <?php if ($comment_min || $comment_max) { ?>onkeyup="check_byte('wr_content', 'char_count');"<?php } ?>></textarea>

            <label for="wr_6">메모</label>
            <textarea id="wr_6" name="wr_6" maxlength="10000" title="메모내용" placeholder="메모를 입력해주세요" 
            <?php if ($comment_min || $comment_max) { ?>onkeyup="check_byte('wr_6', 'char_count');"<?php } ?>></textarea>

            <?php if ($comment_min || $comment_max) { ?>
                <script>
                    check_byte('wr_content', 'char_count');
                    check_byte('wr_6', 'char_count');
                </script>
            <?php } ?>
            <script>
            $(function(){
...
function comment_box(comment_id, work)
{
    ...
    if (save_before != el_id)
    {
        ...
        if (work == 'cu')
        {
            ...
            document.getElementById('wr_6').value = document.getElementById('save_memo_' + comment_id).value;
