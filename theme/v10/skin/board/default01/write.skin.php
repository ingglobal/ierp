...
<section id="bo_w">
    ...
    <div class="bo_w_tit write_div">
        ...
        <div id="autosave_wrapper" class="write_div">
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="제목" style="height:40px;line-height:40px;">
    ...
    <div class="bo_w_flie write_div">
        <div class="file_wr write_div">
            ...
            <input type="file" name="bf_file[]" id="bf_file_<?php echo $i+1 ?>" title="파일첨부 <?php echo $i+1 ?> : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="frm_file " style="margin-top:-2px;">
        </div>
    ...
    <div class="btn_fixed_top">
        <a href="<?php echo get_pretty_url($bo_table); ?>" class="btn_cancel btn" style="background:#9eacc6;color:#fff;line-height:28px;border-radius:5px;">취소</a>
