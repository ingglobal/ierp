...
<!-- 게시물 읽기 시작 { -->
<script>
$('#container_title').text('<?=$board['bo_subject'];?>');
</script>
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <h2 id="bo_v_title" style="font-size:0.8rem;">
    ...
    <section id="bo_v_info">
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
	            ...
	            <?php if ($reply_href && $member['mb_6'] <= 2) { ?><li><a href="<?php echo $reply_href ?>" class="btn_b01 btn" title="답변"><i class="fa fa-reply" aria-hidden="true"></i><span class="sound_only">답변</span></a></li><?php } ?>
