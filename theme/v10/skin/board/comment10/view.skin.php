...
<?php include($board_skin_path.'/company.php');?>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_left">
            ...
            <?php if ($copy_href && $is_admin=='super') { ?><li><a href="<?php echo $copy_href ?>" class="btn_admin btn" onclick="board_move('<?php echo $board_skin_url;;?>/move.php?sw=copy&bo_table=<?php echo $bo_table;?>&wr_id=<?php echo $wr_id;?>'); return false;"><i class="fa fa-files-o" aria-hidden="true"></i> 복사</a></li><?php } ?>
            <?php if ($move_href && $is_admin=='super') { ?><li><a href="<?php echo $move_href ?>" class="btn_admin btn" onclick="board_move('<?php echo $board_skin_url;?>/move.php?sw=move&bo_table=<?php echo $bo_table;?>&wr_id=<?php echo $wr_id;?>'); return false;"><i class="fa fa-arrows" aria-hidden="true"></i> 이동</a></li><?php } ?>
