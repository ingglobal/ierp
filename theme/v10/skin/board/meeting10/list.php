...
// 추가 다른 조건이 있는 경우
if($fr_date) {
    $where2[] = " wr_homepage >= '".$fr_date." 00:00:00' ";
}
if($to_date) {
    $where2[] = " wr_homepage <= '".$to_date." 23:59:59' ";
}
// 방문예정일
if($fr_date2) {
    $where2[] = " wr_facebook_user >= '".$fr_date2."' ";
}
if($to_date2) {
    $where2[] = " wr_facebook_user <= '".$to_date2."' ";
}
if($sch_wr_9) {
    $where2[] = " wr_9 = '".$sch_wr_9."' ";
}
if($sch_wr_10) {
    $where2[] = " wr_10 = '".$sch_wr_10."' ";
}
if($wr_link1) {
    $where2[] = " wr_link1 LIKE '%".$wr_link1."%' ";
}
...
if($sfl=='wr_4') {
    $where2[] = " wr_4 REGEXP 'wr_4=[가-힝]*(".trim($stx).")+[가-힝]*:' ";
}
if($sch_wr_5) {
    $where2[] = " wr_5 = '".$sch_wr_5."' ";
}
