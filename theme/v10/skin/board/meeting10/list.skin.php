...
$colspan = ($member['mb_6'] == 1 || $member['mb_level'] >= 8) ? 6 : 5;
...
function fsearch_submit(f)
{
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col">번호</th>
            <?php if ($is_category) { ?>
            <th scope="col">회의분류</th>
            <?php } ?>
            <th scope="col">회의날짜</th>
            <th scope="col">업체/담당자</th>
            <th scope="col" style="width:600px;">회의제목</th>
...
//            print_r2($list[$i]['cmm']);
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> status_<?php echo $list[$i]['wr_10'];?>">
            ...
            <?php if ($is_category) { ?>
            <td class="td_ca">
                <?php echo '<a href="'.$list[$i]['ca_name_href'].'" class="bo_cate_link">'.$list[$i]['ca_name'].'</a>'; ?>
            </td>
            <?php } ?>
