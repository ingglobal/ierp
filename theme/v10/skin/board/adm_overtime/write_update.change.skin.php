...
if ($w == '' || $w == 'r') {
    ...
    $sql = " insert into $write_table
                set wr_num = '$wr_num',
                     ...
                     wr_9 = '$wr_9',
                     wr_10 = '$wr_10' ";
    include_once($board_skin_path.'/sql_insert.skin.php');
    sql_query($sql);
    ...
    $return_url = G5_USER_ADMIN_URL.'/bbs_write.php?bo_table='.$bo_table.'&amp;w=u&amp;wr_id='.$wr_id;
    ...
    if ($is_admin == 'super') { // 최고관리자 통과
        ...
        if ($member['mb_id'] != $write['mb_id']){
            if($write['wr_mb_id_approver'] == $member['mb_id'] || $member['mb_level'] >= 8 || $member['mb_6'] < 2){
                ;
            }
            else{
    ...
    include_once($board_skin_path.'/sql_update.skin.php');
