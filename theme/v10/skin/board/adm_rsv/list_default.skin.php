...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <?php } ?>
            <th scope="col">번호</th>
            <th scope="col">예약차랑</th>
            <th scope="col">예약자</th>
            <th scope="col">출발일시</th>
            <th scope="col">도착일시</th>
            <th scope="col">메모</th>
            <th scope="col"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>등록일시</a></th>
        </tr>
        </thead>
        <tbody>
        <?php
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
            ...
            <td class="td_subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px">
                ...
                <?php } ?>
                <div class="bo_tit">
                    <a href="<?=G5_USER_ADMIN_URL?>/bbs_write.php?bo_table=<?=$bo_table?>&w=u&wr_id=<?=$list[$i]['wr_id']?>&<?=$qstr?>">
                        <?php echo $bo_carname_value[$list[$i]['subject']]; ?>
                    </a>
                    <?php
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            <a href="<?=G5_USER_ADMIN_URL?>/bbs_board.php?bo_table=<?=$bo_table?>&calendar=1" id="" class="btn_02 btn">달력</a>
        	<?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="btn_admin btn" title="관리자"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">관리자</span></a></li><?php } ?>
            <?php if ($rss_href) { ?><li><a href="<?php echo $rss_href ?>" class="btn_b01 btn" title="RSS"><i class="fa fa-rss" aria-hidden="true"></i><span class="sound_only">RSS</span></a></li><?php } ?>
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="글쓰기"><i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only">글쓰기</span></a></li><?php } ?>
        </ul>	
