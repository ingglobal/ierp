...
if ($w == '' || $w == 'r') {
    ...
    //$return_url = ($calendar) ? $calendar_url : G5_USER_ADMIN_URL.'/bbs_board.php?bo_table='.$bo_table.'&amp;wr_id='.$wr_id;
    $return_url = ($calendar) ? $calendar_url : G5_USER_ADMIN_URL.'/bbs_board.php?bo_table='.$bo_table;
