    ...
    <section id="bo_v_info">
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
	            ...
	            <?php if ($member['mb_6'] <= 2) { ?><li><a href="<?php echo $reply_href ?>" class="btn_b01 btn" title="답변"><i class="fa fa-reply" aria-hidden="true"></i><span class="sound_only">답변</span></a></li><?php } ?>
...
;
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_date_place">
            <i class="fa fa-clock-o"></i> 일시: <?php echo $view['wr_2']; ?> <?php echo substr($view['wr_3'],0,5) ?>
            <?php if($view['wr_4']||$view['wr_6']) echo '~'; ?>
            <?php if($view['wr_6']&&$view['wr_2']!=$view['wr_6']) echo $view['wr_6'] ?>
            <?php if($view['wr_4']) echo ' '.substr($view['wr_4'],0,5) ?>
