...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_btn_top">
        ...
        <div class="btn_fixed_top">
            ...
            <?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="btn_b02 btn" style="background:#ff4081;">글쓰기</a><?php } ?>
        </div>
        <?php } ?>
    </div>
    <!-- } 게시판 페이지 정보 및 버튼 끝 -->
...
//            print_r2($list[$i]['cmm']);
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> status_<?php echo $list[$i]['wr_10'];?>">
            ...
            <td class="td_sales_grade td_left"><?php echo $g5['set_sales_grades_value'][$list[$i]['wr_5']] ?></td><!-- 관심등급 -->
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <li style="display:<?php if(auth_check($auth[$sub_menu],"d",1)) echo 'none';?>"><button type="submit" name="btn_submit" value="선택삭제" onclick="document.pressed=this.value" class="btn btn_admin">선택삭제</button></li>
