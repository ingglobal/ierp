...
<div class="local_desc01 local_desc">
	<p>부품의 수량 및 갯수를 수정하시려면 리스트 내부에 있는 [선택사항수정] 버튼을 클릭하여 내용을 수정하세요.</p>
...
<div id="sod_bsk">
<form name="frmcartlist" id="sod_bsk_list" method="post" action="./order_cart_update.php">
