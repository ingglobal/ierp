    ...
    <td style="width:70%;">
        ...
        <div class="div_main01">
            <div class="main01_left">
                ...
                <!-- 상태별 -->
                <?php
                $sql = "SELECT (CASE WHEN n='1' THEN prp_type ELSE 'total' END) AS item_name
                ...
                for ($i=0; $row=sql_fetch_array($rs) ; $i++) {
                    ...
                    if($row['item_name']=='total') {
                        ...
                        $list[($i-1)]['y'] = ($item_total) ? round(($row['price_total']/$item_total*100),1) : 0;
                    }
                }
                // print_r2($list);
                ?>
                ...
                Highcharts.chart('chart01', {
                    ...
                    series: [{
                        ...
                        for ($i=0; $i < sizeof($list); $i++) {
                            if($i>0) echo ', ';
                            echo "{ name: '".$g5['set_price_type_value'][$list[$i]['name']]."', y: ".$list[$i]['y']." }".PHP_EOL;
                        }
                        ?>
                        ]
                        // data: [
            ...
            <?php
                ...
                $sql = "SELECT (CASE WHEN n='1' THEN ymd_quarter ELSE 'total' END) AS item_name
                            , SUM(price_total) AS price_total
                            , SUM(price_purchase_total) AS price_purchase_total
                            , SUM(price_sales_total) AS price_sales_total
                        FROM
                        (
                            SELECT 
                                ymd_quarter
                            ...
                            (
                                ...
                                SELECT 
                                    n AS ymd_quarter
                                    , 0 AS price_total
                                    , 0 AS price_purchase_total
                                    , 0 AS price_sales_total
