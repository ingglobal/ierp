...
// 업태 추가
if(!isset($default['de_admin_business_condition'])) {
    sql_query(" ALTER TABLE `{$g5['g5_shop_default_table']}`
                    ADD `de_admin_business_condition` varchar(255) NOT NULL DEFAULT '' AFTER `de_taxsave_types`", true);
}
// 업종 추가
if(!isset($default['de_admin_business_category'])) {
    sql_query(" ALTER TABLE `{$g5['g5_shop_default_table']}`
                    ADD `de_admin_business_category` varchar(255) NOT NULL DEFAULT '' AFTER `de_admin_business_condition`", true);
}
// 상호명 추가
if(!isset($default['de_admin_business_name'])) {
    sql_query(" ALTER TABLE `{$g5['g5_shop_default_table']}`
                    ADD `de_admin_business_name` varchar(255) NOT NULL DEFAULT '' AFTER `de_admin_business_category`", true);
}
...
<section id="anc_scf_info">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="de_admin_business_name">상호명</label></th>
            <td>
                <input type="text" name="de_admin_business_name" value="<?php echo get_sanitize_input($default['de_admin_business_name']); ?>" id="de_admin_business_name" class="frm_input" size="30">
            </td>
        ...
        <tr>
            <th scope="row"><label for="de_admin_business_condition">업태</label></th>
            <td>
                <input type="text" name="de_admin_business_condition" value="<?php echo get_sanitize_input($default['de_admin_business_condition']); ?>" id="de_admin_business_condition" class="frm_input" size="30">
            </td>
            <th scope="row"><label for="de_admin_business_category">업종</label></th>
            <td>
                <input type="text" name="de_admin_business_category" value="<?php echo get_sanitize_input($default['de_admin_business_category']); ?>" id="de_admin_business_category" class="frm_input" size="30">
            </td>
        </tr>
        </tbody>
        </table>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr class="kakao_info_fld">
            ...
            <td>
                ...
                <input type="text" name="de_kakaopay_key" value="<?php echo $default['de_kakaopay_key']; ?>" id="de_kakaopay_key" class="frm_input" size="40">
            </td>
        </tr>
        <tr class="kakao_info_fld">
