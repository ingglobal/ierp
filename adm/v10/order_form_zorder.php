<div style="margin:30px auto;width:660px;border:">
	<h2 style="font-size:20px;text-align:center;">발주서</h2>
			...
			<tbody>
				<tr>
					<td style="position:relative;width:40%;border:1px solid #333;text-align:left;padding:5px;vertical-align:top;padding:20px 10px;">
						...
						<p style="margin:0;margin-top:10px;">발주일자 : <?=G5_TIME_YMD?></p>
						...
						<p style="margin:0;position:absolute;left:10px;bottom:10px;font-weight:bold;font-size:0.7em;">납기일 내에 인도해 주시기 바랍니다.</p>
					</td>
