...
<div class="local_desc01 local_desc">
    <p>수정하실 항목만 변경해 주세요.</p>
    <p>비밀번호 항목은 공란으로 두시면 기존의 비빌번호가 그대로 유지됩니다.</p>
</div>

<form name="fmember" id="fmember" action="./my_info_update.php" onsubmit="return fmember_submit(this);" method="post" enctype="multipart/form-data">
