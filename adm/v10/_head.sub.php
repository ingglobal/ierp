...
if( $board['gr_id']=='intra') {
    ...
    //qstr 조건 추가 { -------------------
    // 공통 qstr
    $qstr .= '&fr_date='.$fr_date.'&to_date='.$to_date.'&ser_wr_1='.$ser_wr_1.'&ser_wr_2='.$ser_wr_2.'&ser_wr_10='.$ser_wr_10;
    ...
    // 수입지출게시판 관련
    $qstr_tables3 = array('price1','quot1');
    if( in_array($bo_table,$qstr_tables3) ) {
        $qstr .= '&ser_prj_idx='.$ser_prj_idx;
    }
    // } qstr 조건 추가 -------------------
