...
//루트의 목록영역을 우회하는 후킹: 필요없는경우 스킨폴더에서 "list.change.skin.php"파일을 제거해라
if(is_file($board_skin_path.'/list.change.skin.php')){
    @include_once($board_skin_path.'/list.change.skin.php');
    return;
}
// 분류 사용 여부
$is_category = false;
...
if ($sca || $stx || $stx === '0') {     //검색이면
    ...
    //검색조건을 재정의 하기 위한 검색 후킹소스
    @include_once($board_skin_path.'/list_sch.skin.php');
