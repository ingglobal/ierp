...
.ul_calculate li {float:left;border:solid 1px #ddd;border-radius:5px;padding:10px;background:#5b8c41;width:100%;margin-top:10px;}
...
<section id="gantt_me">
    ...
    <div>
        <div class="div_main01" style="width:100%;<?=((count($list)) ? 'overflow-x:scroll;border:1px solid #dddddd;' : '')?>">
            <div class="main01_left" style="<?=((count($list)) ? 'width:1100px;' : 'width:100%;')?>">
                <?php if(count($list)){ ?>
                <div id="chart1"></div>
                <?php } else { ?>
    ...
    <div class="dash_lst">
        ...
        <div class="div_main01">
            ...
            for ($i=0; $row=sql_fetch_array($result); $i++) {
                ...
                ?>
                    <a href="./project_price_form.php?w=u&prp_idx=<?=$row['prp_idx']?>"><?=cut_str($row['prj_name'],20)?></a>
...
<section id="gantt_all">
    ...
    <div class="div_main01" style="width:100%;overflow-x:scroll;border:1px solid #dddddd;">
        <div class="main01_left" style="width:1100px;">
            <div id="chart2"></div>
            <script>
            // var data_arr = <?=json_encode($list)?>;
            // console.log(JSON.stringify(data_arr));
