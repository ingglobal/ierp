...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		<td>
			<label for="com_name_eng" class="sound_only">영문회사명</label>
			<input type="text" name="com_name_eng" value="<?php echo $com['com_name_eng'] ?>" placeholder="영문회사명" id="com_name_eng" class="frm_input">
		</td>
	</tr>
	<tr>
		<td>
