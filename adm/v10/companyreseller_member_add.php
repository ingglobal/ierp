    ...
    <div class=" new_win_con">
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            for ($i=0; $row=sql_fetch_array($result); $i++) {
                ...
                $s_mod = '<a href="./companyreseller_member_form.php?'.$qstr.'&amp;w=u&amp;cmm_idx='.$row['cmm_idx'].'" class="btn btn_03">수정</a>';
        ...
        <div class="btn_fixed_top">
            ...
            <a href="./companyreseller_select.popup.php?file_name=<?=$g5['file_name']?>" id="btn_company" class="btn btn_03">업체검색</a>
            <?php } ?>
        </div>        
