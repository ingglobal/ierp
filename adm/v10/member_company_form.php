...
<div class="new_win">
        ...
        <div class="tbl_frm01 tbl_wrap">
			...
			<tr>
				<td>
					...
					<input type="text" name="com_name" value="<?php echo $com['com_name'] ?>" placeholder="업체" id="com_name" class="frm_input" style="width:35% !important;display:inline-block;">
					<a href="./company_select.popup.php?file_name=<?=$g5['file_name']?>&frm=form01&tar1=com_idx&tar2=com_name_txt" id="btn_company" class="btn_frmline">업체검색</a>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td><textarea name="cmm_memo" placeholder="메모" id="cmm_memo"><?php echo $cmm['cmm_memo'] ?></textarea></td>
			</tr>
			<tr style="display:none;">
				<td>
					<select name="cmm_status">
	...
	<?php if(G5_IS_MOBILE){ ?>
	<style>
	.win_btn .btn{width:30px;height:30px;line-height:30px;}
	.win_btn .btn_lst{font-size:0;background-position:center;background-repeat:no-repeat;background-image:url(https://icongr.am/fontawesome/list.svg?size=16&color=7a7a7a);}
	.win_btn .btn_delete{font-size:0;background-position:center;background-repeat:no-repeat;background-image:url(https://icongr.am/fontawesome/trash-o.svg?size=19&color=7a7a7a);}
	.win_btn .btn_close{font-size:0;background-position:center;background-repeat:no-repeat;background-image:url(https://icongr.am/fontawesome/times.svg?size=20&color=7a7a7a);}
	</style>
	<?php } ?>
    <div class="win_btn">
		<?php if(!G5_IS_MOBILE){ ?>
		...
		<?php }else{ ?>
        <input type="button" class="btn btn_02 btn_lst" value="목록" onClick="self.location='./member_company_list.php?mb_id=<?=$mb_id?>'">
        <input type="button" class="btn_delete btn" value="삭제" style="display:<?=(!$cmm_idx)?'none':'';?>;">
        <input type="button" class="btn_close btn" value="창닫기" onclick="window.close();">
		<input type="submit" value="확인" class="btn_submit btn" accesskey='s'>
		<?php } ?>
