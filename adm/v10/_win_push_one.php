		...
		<div class=" new_win_con">
			<div class="tbl_frm01 tbl_wrap">
				...
				<tr>
					<th scope="row">푸시키</th>
					<td>
						<input type="text" name="push_key" value="<?=$mb['mb_5']?>" class="frm_input required" required style="width:100%;">
					</td>
				</tr>
				<tr>
					<th scope="row">타이틀</th>
					<td>
						<input type="text" name="push_title" value="테스트입니다. <?=date("His")?>" class="frm_input required" required style="width:100%;">
					</td>
				</tr>
				<tr>
					<?php
					$msg = date("His")."\n제대로 잘 날아가겠지요?\n테스트입니다.\n링크를 타고 잘 이동해야 하는데 왜 안 하지?\n감사합니다.";
					?>
					<th scope="row">메시지</th>
					<td colspan="3"><textarea name="push_content" required class="required"><?=$msg?></textarea></td>
				</tr>
				<tr>
					<th scope="row">URL</th>
					<td>
