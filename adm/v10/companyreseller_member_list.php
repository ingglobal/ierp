...
if(!$com_idx)
    alert_close('판매업체 정보가 존재하지 않습니다.');
$com = get_table_meta('companyreseller','com_idx',$com_idx);

$sql_common = " FROM {$g5['companyreseller_member_table']} AS cmm
    ...
    <div class=" new_win_con">
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            for ($i=0; $row=sql_fetch_array($result); $i++) {
                //print_r2($row);
                $s_mod = '<a href="./companyreseller_member_form.php?'.$qstr.'&amp;w=u&amp;cmm_idx='.$row['cmm_idx'].'" class="btn btn_03" style="background:#ddd;">수정</a>';
        ...
        <div class="btn_fixed_top">
            ...
            <a href="./companyreseller_member_form.php?com_idx=<?=$com_idx?>" id="btn_add" class="btn btn_01">담당자추가</a>
        </div>        
...
$(function() {
	...
	$(".btn_delete").click(function(e) {
		if(confirm('해당 항목을 정말 삭제하시겠습니까?')) {
			...
			self.location="./companyreseller_member_list_update.php?token="+token+"&w=d&cmm_idx="+$(this).attr('cmm_idx');
		}
	});
});
