...
// 용어 설정
$taxonomy = ($taxonomy) ? $taxonomy : 'department';
...
<div class="local_ov01 local_ov">
    ...
    <div style="display:inline-block;float:right;">
        <select name="taxonomy" style="display:none;" class="cp_field" title="분류선택" onFocus='this.initialSelect=this.selectedIndex;' onChange='this.selectedIndex=this.initialSelect;'>
            <option value="">분류 선택</option>
            <?=$g5['set_taxonomies_options']?>
        </select>
        <script>
            $('select[name=taxonomy]').val('<?=$taxonomy?>').attr('selected','selected');
        </script>
    </div>
</div>

<form name="fcarlist" method="post" action="./term_department_list_update.php" autocomplete="off">
...
<tr>
    ...
    <th scope="col" style="width:15%">분류명</th>
    <th scope="col" style="width:10%">분류명2</th>
    <th scope="col" style="width:7%"><a href="javascript:" id="sub_toggle">닫기</a></th>
    <th scope="col" style="width:20%">삭제조직코드</th>
...
<tbody>
	...
	<tr class="" style="display:none">
	    ...
	    <td class="td_trm_content"><!-- 삭제조직코드 -->
	        <input type="text" name="trash_idxs[]" value="" class="full_input frm_input" style="width:100%;">
	    </td>
...
?>
	<tr class="<?php echo $bg; ?>">
	    ...
	    <td class="td_trm_name" style="padding-left:<?=$row['indent']?>px;text-align:left;">
			...
			<input type="text" name="trm_name[]" value="<?php echo get_text(trim($row['term_name'])); ?>" required class="frm_input full_input required" style="width:180px;">
	    </td>
	    ...
	    <td class="td_trm_content"><!-- 삭제조직코드 -->
	        <input type="text" name="trash_idxs[]" value="<?php echo get_text(trim($row['trash_idxs'])); ?>" class="full_input frm_input" style="width:100%;">
	    </td>
