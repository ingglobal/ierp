...
<div class="new_win">
    ...
    <form name="form01" id="form01" action="./employee_auth_setting_update.php" onsubmit="return form01_check(this);" method="post">
        ...
        <div class="tbl_frm01 tbl_wrap">
			...
			<tr>
				...
				<td>
					...
					<a href="./employee_select.php?frm=form01&tar1=mb_id_saler" id="btn_member" class="btn_frmline">검색</a>
				</td>
			</tr>
			<tr>
