...
'de_admin_business_condition',  //업태
'de_admin_business_category',   //업종
'de_admin_business_name',       //상호명
...
$sql = " update {$g5['g5_shop_default_table']}
            set de_admin_company_owner        = '{$de_admin_company_owner}',
                ...
                de_admin_business_condition   = '{$de_admin_business_condition}',
                de_admin_business_category    = '{$de_admin_business_category}',
                de_admin_business_name        = '{$de_admin_business_name}',
