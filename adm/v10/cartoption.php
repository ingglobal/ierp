...
<!-- 장바구니 옵션 시작 { -->
<form name="foption" method="post" action="./order_cart_update.php" onsubmit="return formcheck(this);">
...
<div id="sit_sel_option">
	<ul id="sit_opt_added">
		...
		for($i=0; $row=sql_fetch_array($result); $i++) {
			...
			// 상품가격 수정 가능: 가격이 0일 때만 한번~
			if($row2['ct_price'] > 0 && $member['mb_level'] < 8) {
				$row2['ct_price_readonly'] = ' readonly';
				$row2['ct_price_background'] = 'background-color:#dadada;';
			}
...
<div class="btn_confirm" style="text-align:right;">
    <input type="submit" value="선택사항적용" class="btn btn_03">
    <button type="button" id="mod_option_close" class="btn_cancel btn btn_02">닫기</button>
</div>
</form>
