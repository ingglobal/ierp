...
define('G5_USER_ADMIN_MODAL_PATH',          G5_USER_ADMIN_PATH.'/'.G5_MODAL_DIR);
define('G5_USER_ADMIN_MODAL_URL',           G5_USER_ADMIN_URL.'/'.G5_MODAL_DIR);
define('G5_USER_ADMIN_MODAL_CSS_PATH',      G5_USER_ADMIN_PATH.'/'.G5_MODAL_DIR.'/'.G5_CSS_DIR);
define('G5_USER_ADMIN_MODAL_CSS_URL',       G5_USER_ADMIN_URL.'/'.G5_MODAL_DIR.'/'.G5_CSS_DIR);
